...
flowchart TD
  A[Open face spinning reels]
  A --> B1[Full bail]
  A --> B2[Finger pick up]
  A --> B3[Manual or roller pick up]

  B1 --> C1[Penn 720]
  click C1 "/vintage-reel-service-guides/penn/penn-720-service-guide/"
  B1 --> C2[Pflueger Pelican 1020]
  click C2 "/vintage-reel-service-guides/pflueger/pflueger-pelican-service-guide/"

  B2 --> D1[Ocean City 350 Spin-A-Long]

  B3 --> E1[Pflueger Pelican 1021]
  click E1 "/vintage-reel-service-guides/pflueger/pflueger-pelican-1021-service-guide/"
```
...
flowchart TD
  A[Closed face spinning and spincast reels]
  A --> B1[Closed face spinning]
  A --> B2[Push button spincast]

  B1 --> C1[Shakespeare 1810]
  B1 --> C2[Abu 506]

  B2 --> D1[Zebco 33]
  click D1 "/vintage-reel-service-guides/zebco/zebco-33-service-guide/"
  B2 --> D2[South Bend 88]
  click D2 "/vintage-reel-service-guides/south-bend/south-bend-550-service-guide/"
```
...
----------------|--------------|-------------|----------------|---------------
bass<br>sunfish | light | extra-light<br>light<br>6'--7' | 2--6 | 1/8--3/8
bass<br>rainbow trout<br>grayling | medium-light | light<br>6'6"--7' | 4--8 | 1/4--1/2
