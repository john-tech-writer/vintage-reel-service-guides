...
flowchart TD
  A[Spinning and spincast reels]
  A --> B[Open face]
  A --> C[Closed face]

  B --> B1[Full bail spinning]
  B --> B2[Finger pick up]
  B --> B3[Manual or roller pick up]

  C --> C1[Closed face spinning]
  C --> C2[Push button spincast]

  B1 --> D1[Penn 720 linked service guide]
  click D1 "/vintage-reel-service-guides/penn/penn-720-service-guide/"
  B1 --> D2[Pflueger Pelican 1020 linked service guide]
  click D2 "/vintage-reel-service-guides/pflueger/pflueger-service-guide/"

  B2 --> E1[Ocean City 350 Spin-A-Long]

  B3 --> F1[Pflueger Pelican 1021 linked service guide]
  click F1 "/vintage-reel-service-guides/pflueger/pflueger-1021-service-guide/"

  C1 --> G1[Shakespeare 1810]
  C1 --> G2[Abu 506]

  C2 --> H1[Zebco 33 linked service guide]
  click H1 "/vintage-reel-service-guides/zebco/zebco-33-service-guide/"
  C2 --> H2[South Bend 88 linked service guide]
  click H2 "/vintage-reel-service-guides/south-bend/south-bend-550-service-guide/"
```
