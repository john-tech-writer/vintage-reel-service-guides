# Left- vs. right-handed spinning reels

## The short version

Most spinning reels have the handle on the **left** side. They are made for **right-handed** anglers, who cast and hold the rod with the right hand and crank with the left.

A spinning reel with the handle on the **right** side is made for a **left-handed** angler.
